...
def main():
    ...
    # ---- TIME: yearly counts + rupture mean ----
    ...
    # ---- SPACE: city concentration (Gini) per year ----
    ...
    # ---- SOCIAL: institution_level composition ----
    ...
    # ---- TECH: diffusion_channel composition ----
    ...
    # 4) social: institution share (top 6)
    if len(inst):
    ...
    # 5) tech: diffusion channel share (top 6)
    if len(tech):
